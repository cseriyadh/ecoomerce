...
<head>
    ...
    <link href="{{asset('backend/vendor/font-awesome-4.7/css/font-awesome.min.cs')}}" rel="stylesheet" media="all">
    ...
    <!-- Bootstrap CSS-->
    <link href="{{asset('backend/vendor/bootstrap-4.1/bootstrap.min.csscss')}}" rel="stylesheet" media="all">
